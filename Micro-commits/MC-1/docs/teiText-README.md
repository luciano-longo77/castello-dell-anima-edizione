...
La lezione diplomatica e la sua regolarizzazione coesistono, senza che l’una sostituisca l’altra (in MC‑1 se ne contano 668 coppie: 579 `orig`/`reg`, 30 `abbr`/`expan`, 59 `sic`/`corr`):
