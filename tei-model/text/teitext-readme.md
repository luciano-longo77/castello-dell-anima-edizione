...
![Model](https://img.shields.io/badge/Model-three--layer-orange)
![Encoding](https://img.shields.io/badge/Encoding-diplomatico%2Bgenetico-brightgreen)

> **File**: `castello-anima-teitext-model.xml`
> **Scopo**: documentare struttura, trascrizione a due livelli, apparato genetico e reti intertestuali dell'elemento `<text>`.
> **Allineamento**: coerente con il modello del `teiHeader` (`../header/castello-anima-teiHeader-model.xml`) e con i suoi principi editoriali.
